...
var connectToWorker = function connectToWorker(worker) {
...
var createError = function createError(name, message, stack) {
...
var waitForResponse = function waitForResponse(worker, messageId) {
  return new Promise(function (resolve, reject) {
    ...
    worker.addEventListener('message', function onmessage(event) {
      ...
      worker.removeEventListener('message', onmessage);
      if (message.error) {
        return reject(createError(message.error.name, message.error.message, message.error.stack));
      }
...
var ProxyWorker = function () {
  ...
  _createClass(ProxyWorker, [{
    key: 'callWithArgs',
    value: function callWithArgs(method) {
      var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

      var detail = { messageType: 'rpc', method: method, args: args };
      return this.sendMessage(detail);
    }
  }, {
    key: 'subscribe',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(eventType, subscriber) {
        var detail, subscribers, subscription;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                detail = { messageType: 'subscribe', eventType: eventType };
                _context.next = 6;
                return this.sendMessage(detail);
                ...
                subscription = {
                  ...
                  onmessage: function onmessage(event) {
                    ...
                    subscribers.forEach(function (subscriber) {
                      return subscriber(message.args);
                    });
                  }
                };
    ...
    key: 'unsubscribe',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(eventType, subscriber) {
        var _subscriptions$eventT, subscribers, onmessage, detail;

        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _subscriptions$eventT = this.subscriptions[eventType], subscribers = _subscriptions$eventT.subscribers, onmessage = _subscriptions$eventT.onmessage;
              ...
              case 4:
                detail = { messageType: 'unsubscribe', eventType: eventType };
                _context2.next = 7;
                return this.sendMessage(detail);
    ...
    key: 'sendMessage',
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(detail) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                message = _extends({ messageId: messageId }, detail);

                this.worker.postMessage(message);
                _context3.next = 7;
                return waitForResponse(this.worker, messageId);
...
var ProxyWorker = require('./ProxyWorker');
...
},{"./ProxyWorker":1,"./proxy":3,"babel-polyfill":4}],3:[function(require,module,exports){
'use strict';
...
var isPromise = function isPromise(thing) {
  return (typeof thing === 'function' || (typeof thing === 'undefined' ? 'undefined' : _typeof(thing)) === 'object') && typeof thing.then === 'function';
};

var toStringOrNull = function toStringOrNull(thing) {
  if (thing == null) {
    return null;
  }
...
var findString = function findString(candidates) {
  return toStringOrNull(candidates.find(Boolean));
};

var respondToMessage = function respondToMessage(messageId, response) {
  var message = { messageType: 'response', messageId: messageId, response: response };
  self.postMessage(message);
};

var reportError = function reportError(messageId, error) {
  var message = {
...
var emit = function emit(eventType) {
  var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  ...
  var message = { messageType: 'event', eventType: eventType, args: args };
  self.postMessage(message);
};
...
var proxy = function proxy(api) {
  var handleRpc = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(message) {
      var args, messageId, method, _api$methods, result, value;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              args = message.args, messageId = message.messageId, method = message.method;
              ...
              return _context.abrupt('return', reportError(messageId, new Error(method + ' not implemented by worker')));

            case 3:
              _context.prev = 3;
              result = (_api$methods = api.methods)[method].apply(_api$methods, _toConsumableArray(args));
              ...
              return _context.abrupt('return', respondToMessage(messageId, result));
            ...
            case 9:
              value = _context.sent;
              return _context.abrupt('return', respondToMessage(messageId, value));

            case 13:
              _context.prev = 13;
              _context.t0 = _context['catch'](3);

              reportError(messageId, _context.t0);
    ...
    return function handleRpc(_x2) {
      return _ref.apply(this, arguments);
    };
  }();

  var handleSubscription = function handleSubscription(message) {
...
},{"core-js/fn/regexp/escape":5,"core-js/shim":328,"regenerator-runtime/runtime":329}],5:[function(require,module,exports){
